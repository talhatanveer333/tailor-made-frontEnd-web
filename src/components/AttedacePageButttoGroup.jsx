...
const Index = () => {
  ...
  return (
    <div className="py-12 flex w-full justify-center">
      <div
        id="filters"
        className="bg-transparent border-2 border-gray-200 dark:border-gray-800 rounded flex items-center"
      >
        <div
          onClick={() => setTechType("html")}
          className={
            techType == "html"
              ? "text-brand bg-gray-100 dark:bg-gray-800 w-16 h-16 flex justify-center items-center "
              : "w-16 h-16 focus:text-brand dark:focus:text-brand hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50 flex justify-center items-center cursor-pointer focus:bg-gray-100 dark:focus:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-800"
          }
        >
          <svg
            width={25}
        ...
        >
          ...
          >
            <path
              d="M20 3.33331L35.5 8.86665L33.1367 29.3833L20 36.6666L6.86333 29.3833L4.5 8.86665L20 3.33331ZM20 7.01665L10.31 28.7666H13.9233L15.8717 23.9H24.095L26.045 28.7666H29.6567L20 7.01665ZM22.83 20.9H17.17L20 14.0833L22.83 20.9Z"
              fill="currentColor"
            />
          </svg>
        </div>
        <div
          onClick={() => setTechType("react")}
          className={
            techType == "react"
              ? "text-brand bg-gray-100 dark:bg-gray-800 w-16 h-16 flex justify-center items-center "
              : "w-16 h-16 focus:text-brand dark:focus:text-brand hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50 flex justify-center items-center cursor-pointer focus:bg-gray-100 dark:focus:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-800"
        ...
        >
          ...
          >
            <path
              d="M1.66675 5H8.33341L20.0001 25L31.6667 5H38.3334L20.0001 36.6667L1.66675 5ZM16.1117 5L20.0001 11.6667L23.8884 5H30.6134L20.0001 23.3333L9.38675 5H16.1117Z"
              fill="currentColor"
            />
          </svg>
        </div>
